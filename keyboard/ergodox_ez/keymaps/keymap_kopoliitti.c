 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |LCtrl | LGui | LAlt |      |  ~L1 |                                       | ~L1 | Left |  Up  | Down | Right |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | App  | Paus |       | Del  |Ctrl/Esc|
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       | PgUp |        |      |
 *                                 | Space|Backsp|------|       |------|  RAlt  |Enter |
 *                                 |      |ace   | End  |       | PgDn |        |      |
 *                                 `--------------------'       `----------------------'
 */
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LSFT,        KC_NUBS,      KC_Z,   KC_X,   KC_C,   KC_V,   KC_NO,
        KC_LCTL,        KC_LGUI,      KC_LALT,KC_NO,  MO(1),
                                              ALT_T(KC_APP),  KC_PAUS,
                                                              KC_HOME,
        ...
        // right hand
             ...
             KC_NO,       KC_B,   KC_N,   KC_M,   KC_COMM,CTL_T(KC_DOT),    SFT_T(KC_SLSH),
                                  MO(1),  KC_LEFT,KC_UP,  KC_DOWN,          KC_RIGHT,
             KC_DEL,      CTL_T(KC_ESC),
             KC_PGUP,
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, NO_AMP,  KC_1,   KC_2,    KC_3,    ALGR(NO_PLUS), KC_TRNS,
